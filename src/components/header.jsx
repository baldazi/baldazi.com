...
function Header() {
    ...
    return (
        <header className="dark:text-gray-300 text-gray-800">
            <div className="flex justify-between items-center pt-2 pl-5 lg:px-32 bg-emerald-700 dark:bg-emerald-900 text-lg">

                <div className="">
                    <Link to="/" className="dark:hover:text-white hover:text-black" onClick={e => setMenuToggle(false)}>
                ...
                <nav className="hidden lg:block">
                    <ul className="tabs tabs-bordered" role="tablist">
                        <li>
                            <NavLink role="tab" to="/" className={({ isActive }) => (isActive ? activeNavClass : navClass)}><IoHome className="mr-1" />{m["navigation.home"]()}</NavLink>
                        </li>
                        <li>
                ...
                <div className="hidden lg:flex items-center gap-3 dark:hover:text-white hover:text-black">
                    <LangSelector />
                    <ThemePicker />
                </div>
            </div>
